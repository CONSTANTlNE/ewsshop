...
class ProductStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'new_spec.*'    => 'sometimes|string|max:60',
            'new_value'     => 'sometimes|array',
            'new_value.*'   => 'sometimes|string|max:200',
            'old_spec'      => 'sometimes|array',
            'old_spec.*'    => 'sometimes|string|max:60',
            'old_value'     => 'sometimes|array',
            'old_value.*'   => 'sometimes|string|max:200',
    ...
    public function messages()
    {
        return [
            ...
            'name.string'          => 'დასახელება არ შეიძლება იყოს ცარიელი',
            ...
            'description.string'   => 'აღწერა შეიძლება იყოს ცარიელი',
            ...
            'new_value.*.max'      => 'ინფორმაციამ არ უნდ ააღემატებოდეს 200 ლართინურ სიმბოლოს',
