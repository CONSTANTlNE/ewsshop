            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        ...
                        @if(auth()->check() && auth()->user()->auth_type===null)
                            <div class="flex-row justify-content-center align-middle mt-2 w-100">
                    ...
                    <li>
                        <div class="flex-row justify-content-center align-middle">
                            <input id="use_logo" style="height: 25px;" name="use_logo"
                                   ...
                                   type="checkbox"
                                   @if($shop->settings->first()->use_logo==1)checked="" @endif >
                        ...
                        <div class="flex-row justify-content-center align-middle mt-2">
                            <input id="show_description" style="height: 25px;" name="show_description"
                                   class="form-check-input"
                                   type="checkbox"
                                   @if($shop->settings->first()->show_description==1)checked="" @endif >
                        ...
                        <div class="flex-row justify-content-center align-middle mt-2">
                            <input style="height: 25px;" id="whatsapp" name="whatsapp"
                                   class="form-check-input" type="checkbox"
                                   value=""
                                   @if($shop->settings->first()->whatsapp===1)checked="" @endif >
                        ...
                        <div class="flex-row justify-content-center align-middle mt-2">
                            <input style="height: 25px;" id="use_description" name="use_description"
                                   class="form-check-input" type="checkbox"
                                   value=""
                                   @if($shop->settings->first()->use_description===1)checked @endif >
...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart">
    <div class="shop-sidebar-wrap">
        ...
        <div class="user-panel">
            <ul>
                <li><a href="tel:{{$shop->user->mobile}}">
                ...
                @if($shop->address!==null)
                    <li>
                        <a  href="https://www.google.com/maps/search/?api=1&query={{$shop->address}}" target="_blank">
...
<div id="offcanvas-mobile-menu" class="offcanvas offcanvas-mobile-menu">
    ...
    <div class="user-panel">
        <ul>
            <li><a href="tel:{{$shop->user->mobile}}"><i class="fa fa-phone"></i>{{$shop->user->mobile}}</a></li>
            @if($shop->address!==null)
                <li>
                    <a  href="https://www.google.com/maps/search/?api=1&query={{$shop->address}}" target="_blank">
