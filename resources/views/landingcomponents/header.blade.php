<header id="navbar" class="light fixed top-0 inset-x-0 flex items-center z-40 w-full lg:bg-transparent bg-white transition-all py-5">
    <div class="container">
        <nav class="flex items-center">
            <!-- Navbar Brand Logo -->
            <a href="index.html">
                <img src="{{asset('landingassets/images/logo-dark.png')}}" class="h-8 logo-dark" alt="Logo Dark">
                <img src="{{asset('landingassets/images/logo-light.png')}}" class="h-8 logo-light" alt="Logo Light">
            </a>
