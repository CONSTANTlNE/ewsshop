                                ...
                                <div class="header-bottom-set dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a class="dropdown-item"
                                               href="{{route('categories.sorted',['shop'=>request()->segment(1),'category'=>request()->segment(2),'sort'=>'price_asc'])}}">ფასი
                                                ზრდადი</a></li>
                                        <li><a class="dropdown-item"
                                               href="{{route('categories.sorted',['shop'=>request()->segment(1),'category'=>request()->segment(2),'sort'=>'price_desc'])}}">ფასი
                                                კლებადი</a></li>
                                        <li><a class="dropdown-item"
                                               href="{{route('categories.sorted',['shop'=>request()->segment(1),'category'=>request()->segment(2),'sort'=>'oldest'])}}">თარიღი
                                                ზრდადი</a></li>
                                        <li><a class="dropdown-item"
                                               href="{{route('categories.sorted',['shop'=>request()->segment(1), 'category'=>request()->segment(2),'sort'=>'newest'])}}">თარიღი
                                                კლებადი</a></li>
                                    </ul>
                                </div>
                                <!-- Single Wedge Start -->
