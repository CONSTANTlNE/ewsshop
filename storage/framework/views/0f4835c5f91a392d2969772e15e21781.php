<div id="searcherror" class="text-center">
    <?php if(isset($searcherror)): ?>
       <p class="text-center"><?php echo e($searcherror); ?></p>
    <?php endif; ?>
</div>
        ...
        >
            <div class="d-flex justify-content-start align-items-center mb-1">
                    ...
                    <?php $__currentLoopData = $product->media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($loop->first): ?>
                            <img style="width: 70px;height: 70px;margin:5px;border-radius: 7px"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH E:\HERD\catalogue\resources\views/htmx/search.blade.php ENDPATH**/ ?>