            ...
            <div class="row d-flex justify-content-center align-items-center">
                <div style="max-width: min-content" class="col">
                    <div  class="header-logo d-flex justify-content-start align-items-center">
                        <?php if($shop->settings->first()->use_logo==1): ?>
                        <div class="d-flex">
                            <a class="d-flex justify-content-center align-items-center"
                               href="<?php echo e(route('home',['shop' => request()->segment(1)])); ?>">
                                
                                <?php $__currentLoopData = $shop->media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img style="width: auto; max-height: 50px"
                                         src="<?php echo e($logo->getUrl()); ?>" alt="Site Logo"/>

                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if($shop->media->isEmpty()): ?>
                                    <img style="width: auto; max-height: 50px"
                                         src="<?php echo e(asset('assets/images/logo/logonobg.png')); ?>" alt="Site Logo"/>
                                <?php endif; ?>
                            </a>
                            <?php if(auth()->guard()->check()): ?>
                                <input style="display: none" type="file" data-logo-imagefile>
                                <form class="logoform" style="margin:auto; height: 30px;width: 30px;"
                                      action="<?php echo e(route('update.logo')); ?>"
                                      method="post">
                                    <?php echo csrf_field(); ?>
                        ...
                        <div style="position: relative ; padding-bottom: 0!important" class="search-element max-width-100">
                            ...
                            <form>
                                <input
                                        ...
                                        hx-get="<?php echo e(route('product.searchmobile', ['shop' => request()->segment(1)])); ?>"
                ...
                <div  style="max-width: min-content" class="col-lg-3 col">
                    <div class="header-actions ">
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <form style="margin-bottom: 0!important" action="<?php echo e(route('logout')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                        ...
                        <div style="position: relative" class="search-element">
                            <form>
                                <input
                                        id="searchinput"
                                        hx-trigger="keyup delay:800ms,paste delay:800ms"
                                        hx-get="<?php echo e(route('product.search', ['shop' => request()->segment(1)])); ?>"
                    ...
                    <div class="col-lg-3 col">
                        <div class="header-actions">
                            <?php if(auth()->guard()->check()): ?>
                                ...
                                <form style="margin-bottom: 0!important" action="<?php echo e(route('logout')); ?>"
                                      method="post">
                                    <?php echo csrf_field(); ?>
...
</header><?php /**PATH E:\HERD\catalogue\resources\views/components/header.blade.php ENDPATH**/ ?>