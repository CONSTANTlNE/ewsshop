...
<input  style="max-width: 300px " class="form-input" type="text" name="title" placeholder="სასურველი ტექსტი" <?php if($header): ?> value="<?php echo e($header->name); ?>" <?php endif; ?>>
<input type="hidden" id="token2" name="_token" value="<?php echo e(csrf_token()); ?>">
    <button
            hx-post="<?php echo e(route('shop.populartext.update',['shop'=>request()->segment(1)])); ?>"
...
<?php /**PATH E:\HERD\catalogue\resources\views/htmx/populartext.blade.php ENDPATH**/ ?>