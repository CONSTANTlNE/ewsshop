...
<head>
    ...
    <meta property="og:image" content="<?php echo e(asset('landingassets/landingimages/og.png')); ?>">
...
<body class="text-gray-800">
        ...
        <!-- =========== Navbar Start =========== -->
<?php echo $__env->make('landingcomponents.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!-- =========== Navbar End =========== -->

<!-- =========== Mobile Menu Start (Offcanvas) =========== -->
<?php echo $__env->make('landingcomponents.mobilemenu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!-- =========== Mobile Menu End =========== -->
...
<section class="bg-gradient-to-t from-slate-500/10 relative">
                            ...
                            <div class="swiper-wrapper">
                                <div style="max-height: 370px!important" class="swiper-slide">
                                    <img style="height: 100%!important"
                                         src="<?php echo e(asset('landingassets/landingimages/1.png')); ?>" alt="saas1"
                                         class=" rounded-md">
                                </div>
                                <div style="max-height: 370px!important" class="swiper-slide">
                                    <img style="height: 100%!important"
                                         src="<?php echo e(asset('landingassets/landingimages/2.png')); ?>" alt="saas1"
                                         class="w-full h-full rounded-md">
                                </div>
                                <div style="max-height: 370px!important" class="swiper-slide">
                                    <img style="height: 100%!important"
                                         src="<?php echo e(asset('landingassets/landingimages/3.png')); ?>" alt="saas1"
                                         class="w-full h-full rounded-md">
                                </div>
                                <div style="max-height: 370px!important" class="swiper-slide">
                                    <img style="height: 100%!important"
                                         src="<?php echo e(asset('landingassets/landingimages/sort.png')); ?>" alt="saas1"
                                         class="w-full h-full rounded-md">
                                </div>
                                <div style="max-height: 370px!important" class="swiper-slide">
                                    <img style="height: 100%!important"
                                         src="<?php echo e(asset('landingassets/landingimages/single.png')); ?>" alt="saas1"
                                         class="w-full h-full rounded-md">
                                </div>
                            </div>
                        </div>
    ...
    <div class="absolute bottom-0 inset-x-0 hidden sm:block">
        <img src="<?php echo e(asset('landingassets/images/shapes/white-wave.svg')); ?>" alt="white-wave-svg"
            ...
            <div class="xl:pt-16 xl:pb-28 py-16">
                <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 items-center">
                    ...
                    <div class="relative">
                        ...
                        <a href="<?php echo e(asset('landingassets/landingimages/categories.png')); ?>" class="glightbox">
                        <img style="border-radius: 15px" src="<?php echo e(asset('landingassets/landingimages/categories.png')); ?>"
                             alt="saas1"
                             data-aos="fade-right"
            ...
            <div class="mt-7">
                <div class="grid lg:grid-cols-2 grid-cols-1n gap-6 items-center">
                    ...
                    <div class="relative order-1 lg:order-2">
                        ...
                        <a href="<?php echo e(asset('landingassets/landingimages/product.png')); ?>" class="glightbox">
                        <img style="border-radius: 15px" src="<?php echo e(asset('landingassets/landingimages/product.png')); ?>"
                             alt="saas2"
                             data-aos="fade-left"
                             data-aos-duration="400">
                        </a>
            ...
            <div class="xl:pt-16 xl:pb-28 py-16">
                <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 items-center">
                    ...
                    <div class="relative">
                        ...
                        <a href="<?php echo e(asset('landingassets/landingimages/1.png')); ?>" class="glightbox">

                        <img style="border-radius: 15px" src="<?php echo e(asset('landingassets/landingimages/1.png')); ?>"
                             alt="saas1"
                             data-aos="fade-right"
                             data-aos-duration="400">
                        </a>
            ...
            <div class="mt-7">
                <div class="grid lg:grid-cols-2 grid-cols-1n gap-6 items-center">
                    ...
                    <div class="relative order-1 lg:order-2">
                        ...
                        <a href="<?php echo e(asset('landingassets/landingimages/sort.png')); ?>" class="glightbox">

                        <img style="border-radius: 15px" src="<?php echo e(asset('landingassets/landingimages/sort.png')); ?>"
                             alt="saas2"
                             data-aos="fade-left"
                             data-aos-duration="400">
            ...
            <div class="xl:pt-16 xl:pb-28 py-16">
                <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 items-center">
                    ...
                    <div class="relative">
                        ...
                        <a href="<?php echo e(asset('landingassets/landingimages/3.png')); ?>" class="glightbox">

                        <img style="border-radius: 15px" src="<?php echo e(asset('landingassets/landingimages/3.png')); ?>"
                             alt="saas1"
                             data-aos="fade-right"
                             data-aos-duration="400">
            ...
            <div class="mt-7">
                <div class="grid lg:grid-cols-2 grid-cols-1n gap-6 items-center">
                    ...
                    <div class="relative order-1 lg:order-2">
                        ...
                        <a href="<?php echo e(asset('landingassets/landingimages/socials.png')); ?>" class="glightbox">

                        <img style="border-radius: 15px" src="<?php echo e(asset('landingassets/landingimages/socials.png')); ?>"
                             alt="saas2"
                             data-aos="fade-left"
                             data-aos-duration="400">
...
<!-- Swiper Plugin Js -->
<script src="<?php echo e(asset('landingassets/libs/swiper/swiper-bundle.min.js')); ?>"></script>

<!-- Animation on Scroll Plugin Js -->
<script src="<?php echo e(asset('landingassets/libs/aos/aos.js')); ?>"></script>

<!-- Theme Js -->
<script src="<?php echo e(asset('landingassets/js/theme.min.js')); ?>"></script>
...
</html><?php /**PATH E:\HERD\catalogue\resources\views/index.blade.php ENDPATH**/ ?>