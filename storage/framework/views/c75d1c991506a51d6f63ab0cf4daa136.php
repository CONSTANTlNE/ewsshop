                                ...
                                <div class="header-bottom-set dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a class="dropdown-item"
                                               href="<?php echo e(route('categories.sorted',['shop'=>request()->segment(1),'category'=>request()->segment(2),'sort'=>'price_asc'])); ?>">ფასი
                                                ზრდადი</a></li>
                                        <li><a class="dropdown-item"
                                               href="<?php echo e(route('categories.sorted',['shop'=>request()->segment(1),'category'=>request()->segment(2),'sort'=>'price_desc'])); ?>">ფასი
                                                კლებადი</a></li>
                                        <li><a class="dropdown-item"
                                               href="<?php echo e(route('categories.sorted',['shop'=>request()->segment(1),'category'=>request()->segment(2),'sort'=>'oldest'])); ?>">თარიღი
                                                ზრდადი</a></li>
                                        <li><a class="dropdown-item"
                                               href="<?php echo e(route('categories.sorted',['shop'=>request()->segment(1), 'category'=>request()->segment(2),'sort'=>'newest'])); ?>">თარიღი
                                                კლებადი</a></li>
                                    </ul>
                                </div>
                                <!-- Single Wedge Start -->
...
<?php echo $__env->make('pages.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\HERD\catalogue\resources\views/pages/categories.blade.php ENDPATH**/ ?>