    ...
    <div class="container">
        <nav class="flex items-center">
            ...
            <a href="<?php echo e(route('index')); ?>">
                <img src="<?php echo e(asset('assets/images/logo/logonobg.png')); ?>" class="h-8 logo-dark" alt="Logo Dark">
                <img src="<?php echo e(asset('assets/images/logo/logonobg.png')); ?>" class="h-8 logo-light" alt="Logo Light">
            </a>
...
<?php /**PATH E:\HERD\catalogue\resources\views/landingcomponents/header.blade.php ENDPATH**/ ?>